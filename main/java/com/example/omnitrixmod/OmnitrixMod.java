...
import com.example.omnitrixmod.container.ContainerTypes;
import com.example.omnitrixmod.entities.playermodels;
...
import com.example.omnitrixmod.screens.OmnitrixGUIScreen;
...
import static com.example.omnitrixmod.entities.playermodels.ghostfreakstandard;
...
public class OmnitrixMod
{
    ...
    public static final String MODID = "omnitrixmod";
    ...
    public static class RegistryEvents {
        ...
        public static void onItemRegistry(final RegistryEvent.Register<Item> itemRegisteryEvent){
            renderingregistry.onItemRegistry(itemRegisteryEvent);
        }

        @SubscribeEvent
        public static void onClientSetupEvent(FMLClientSetupEvent event) {
            ScreenManager.register(ContainerTypes.OMNITRIX_CONTAINER.get(), OmnitrixGUIScreen::new);
